...
// required and conditionally may not be compiled in.
    ...
    // Used with written permission and attributed to Brainstone by CC BY-SA 3.0 as per
    // https://stackoverflow.com/questions/53365538
...
namespace Mezzanine
{
    ...
    /// @brief Some way compatible with std::filesystem::path to work with filesystem paths.
