            ...
            parallel {
                ...
                stage('UbuntuEmscripten') {
                    ...
                    steps {
                        sh 'mkdir -p build-debug'
                        dir('build-debug') { sh """
                            cmake -G"Ninja" .. -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_C_COMPILER=emcc -DCMAKE_CXX_COMPILER=em++ -DMEZZ_BuildDoxygen=OFF -DMEZZ_CodeCoverage=OFF &&
                            ninja &&
            ...
            parallel {
                ...
                stage('UbuntuEmscripten') {
                    ...
                    steps {
                        sh 'mkdir -p build-release'
                        dir('build-release') { sh """
                            cmake -G"Ninja" .. -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_C_COMPILER=emcc -DCMAKE_CXX_COMPILER=em++ -DMEZZ_BuildDoxygen=OFF -DMEZZ_CodeCoverage=OFF &&
                            ninja &&
